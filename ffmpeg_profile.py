...
builtin_profiles = {
    ...
    # Perfiles con soporte alpha/transparencia para overlays
    "alpha-qtrle": {
        "input": [],
        "output": ["-vcodec", "qtrle", "-pix_fmt", "argb"]  # QuickTime Animation con alpha
    },
    "alpha-prores": {
        "input": [],
        "output": ["-vcodec", "prores_ks", "-pix_fmt", "yuva444p10le", "-profile:v", "4444"]  # ProRes 4444 con alpha
    },
    "alpha-webm": {
        "input": [],
        "output": ["-vcodec", "libvpx-vp9", "-pix_fmt", "yuva420p"]  # VP9 con alpha en WebM
    },
    "alpha-png": {
        "input": [],
        "output": ["-vcodec", "png"]  # Secuencia PNG (cada frame como PNG)
    },
    "overlay-capcut": {
        "input": [],
        "output": ["-r", "30", "-vf", "premultiply_dynamic", "-vcodec", "png", "-pix_fmt", "rgba"]  # PNG con alpha premultiplicado para CapCut
    }
}
